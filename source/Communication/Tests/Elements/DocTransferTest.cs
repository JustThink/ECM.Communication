...
{
	[TestFixture]
	public class DocTransferTest : HelperTest
	{
		[Test]
		public void TestCreate()
		{
			var type = new DocTransfer();
			Assert.IsNull(type.os);
			Assert.IsNull(type.type);
			Assert.IsNull(type.description);
		}
		...
		public void TestMissingRequiredAttribute_Format()
		{
			...
			var arg0 = "os";
			var arg1 = DocTransfer.ElementName;
