    ...
    public partial class AcknowledgementType
    {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(Communication.AcknowledgementType));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Communication.AcknowledgementType obj, out System.Exception exception)
        {
            exception = null;
            obj = default(Communication.AcknowledgementType);
            try
            {
                obj = Deserialize(xml);
                return true;
        ...
        public static bool Deserialize(string xml, out Communication.AcknowledgementType obj)
        {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }

        public static Communication.AcknowledgementType Deserialize(string xml)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(xml);
                return ((Communication.AcknowledgementType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Communication.AcknowledgementType obj, out System.Exception exception)
        {
            exception = null;
            obj = default(Communication.AcknowledgementType);
            try
        ...
        public static bool LoadFromFile(string fileName, out Communication.AcknowledgementType obj, out System.Exception exception)
        {
            return LoadFromFile(fileName, Encoding.UTF8, out obj, out exception);
        }

        public static bool LoadFromFile(string fileName, out Communication.AcknowledgementType obj)
        {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static Communication.AcknowledgementType LoadFromFile(string fileName)
        {
            return LoadFromFile(fileName, Encoding.UTF8);
        }

        public static Communication.AcknowledgementType LoadFromFile(string fileName, System.Text.Encoding encoding)
        {
