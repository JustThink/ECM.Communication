    ...
    public partial class DocumentType
    {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(Communication.DocumentType));
                }
                return serializer;
            }
        }
        ...
        public static bool Deserialize(string xml, out Communication.DocumentType obj, out System.Exception exception)
        {
            exception = null;
            obj = default(Communication.DocumentType);
            try
            {
                obj = Deserialize(xml);
                return true;
        ...
        public static bool Deserialize(string xml, out Communication.DocumentType obj)
        {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }

        public static Communication.DocumentType Deserialize(string xml)
        {
            System.IO.StringReader stringReader = null;
            try
            {
                stringReader = new System.IO.StringReader(xml);
                return ((Communication.DocumentType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally
            {
        ...
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out Communication.DocumentType obj, out System.Exception exception)
        {
            exception = null;
            obj = default(Communication.DocumentType);
            try
        ...
        public static bool LoadFromFile(string fileName, out Communication.DocumentType obj, out System.Exception exception)
        {
            return LoadFromFile(fileName, Encoding.UTF8, out obj, out exception);
        }

        public static bool LoadFromFile(string fileName, out Communication.DocumentType obj)
        {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }

        public static Communication.DocumentType LoadFromFile(string fileName)
        {
            return LoadFromFile(fileName, Encoding.UTF8);
        }

        public static Communication.DocumentType LoadFromFile(string fileName, System.Text.Encoding encoding)
        {
